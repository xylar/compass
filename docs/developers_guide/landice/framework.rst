...
values do not contaminate the interpolation stencil.  Pass
``decode_times=False`` for source files whose time coordinate is not
CF-compliant, such as the fracture forcing.
