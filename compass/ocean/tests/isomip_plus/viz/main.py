...
from compass.ocean.tests.isomip_plus.viz.streamfunction import \
    compute_barotropic_streamfunction, compute_overturning_streamfunction
from compass.ocean.tests.isomip_plus.viz.plot import MoviePlotter, \
    TimeSeriesPlotter
from compass.ocean.tests.isomip_plus.viz.misomip import \
    compute_misomip_interp_coeffs, interp_misomip
from compass.ocean.tests.isomip_plus.viz.haney import compute_haney_number


def main():
    parser = argparse.ArgumentParser(
        description='Visualize ISOMIP+ output')
